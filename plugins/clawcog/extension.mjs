...
// clawcog — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "clawcog_guide",
            description: "Provide guidance using the clawcog skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# clawcog Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/clawcog/SKILL.md for detailed guidance on this topic.
