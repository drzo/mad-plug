...
// llama-cpp-spec — Knowledge-based skill plugin
// This plugin exposes the skill as a guidance tool

await joinSession({
    tools: [
        {
            name: "llama_cpp_spec_guide",
            description: "Provide guidance using the llama-cpp-spec skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# llama-cpp-spec Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/llama-cpp-spec/SKILL.md for detailed guidance on this topic.
