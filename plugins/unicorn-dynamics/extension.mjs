...
// unicorn-dynamics — Knowledge-based skill plugin
// This plugin exposes the skill as a guidance tool

await joinSession({
    tools: [
        {
            name: "unicorn_dynamics_guide",
            description: "Provide guidance using the unicorn-dynamics skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# unicorn-dynamics Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/unicorn-dynamics/SKILL.md for detailed guidance on this topic.
