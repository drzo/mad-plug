...
// skill-nn — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "skill_nn_guide",
            description: "Provide guidance using the skill-nn skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# skill-nn Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/skill-nn/SKILL.md for detailed guidance on this topic.
