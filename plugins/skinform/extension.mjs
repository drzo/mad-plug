...
// skinform — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "skinform_guide",
            description: "Provide guidance using the skinform skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# skinform Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/skinform/SKILL.md for detailed guidance on this topic.
