...
// time-crystal-nn — Knowledge-based skill plugin
// This plugin exposes the skill as a guidance tool

await joinSession({
    tools: [
        {
            name: "time_crystal_nn_guide",
            description: "Provide guidance using the time-crystal-nn skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# time-crystal-nn Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/time-crystal-nn/SKILL.md for detailed guidance on this topic.
