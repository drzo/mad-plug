...
// o9c — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "o9c_guide",
            description: "Provide guidance using the o9c skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
...
Refer to the skill documentation in skills/o9c/SKILL.md for detailed guidance on this topic.
