...
// sys-n — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "sys_n_guide",
            description: "Provide guidance using the sys-n skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# sys-n Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/sys-n/SKILL.md for detailed guidance on this topic.
