...
// apl253 — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "apl253_guide",
            description: "Provide guidance using the apl253 skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# apl253 Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/apl253/SKILL.md for detailed guidance on this topic.
