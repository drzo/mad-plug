...
// scm-des — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "scm_des_guide",
            description: "Provide guidance using the scm-des skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
            ...
            handler: async (args) => {
                ...
                return `# scm-des Guidance

## Topic: ${args.topic}
${args.context ? `Context: ${args.context}` : ""}

Refer to the skill documentation in skills/scm-des/SKILL.md for detailed guidance on this topic.
