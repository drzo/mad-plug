---
name: npu
description: Build and operate Neural Processing Unit virtual hardware abstractions for LLM integration. Use when modeling LLM inference as memory-mapped peripheral devices, creating virtual PCB architectures with MMIO registers, DMA controllers, and interrupt systems, or integrating GGUF-backed coprocessors into cognitive systems. Covers VirtualPCB, LLM coprocessor drivers, financial hardware platforms, telemetry dashboards, and CogMorph multi-projection state transforms. Triggers on mentions of NPU, neural processing unit, virtual hardware, MMIO registers, LLM coprocessor, virtual PCB, or hardware-first LLM integration.
---
