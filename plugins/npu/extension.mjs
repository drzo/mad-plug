...
// npu — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "npu_guide",
            description: "Provide guidance using the npu skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
...
Refer to the skill documentation in skills/npu/SKILL.md for detailed guidance on this topic.
