...
// tc — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "tc_guide",
            description: "Provide guidance using the tc skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
...
Refer to the skill documentation in skills/tc/SKILL.md for detailed guidance on this topic.
