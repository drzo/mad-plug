...
// nn — Knowledge-based skill plugin
...
await joinSession({
    tools: [
        {
            name: "nn_guide",
            description: "Provide guidance using the nn skill knowledge base. Returns structured knowledge for the given topic.",
            parameters: {
                type: "object",
                properties: {
                    topic: {
...
Refer to the skill documentation in skills/nn/SKILL.md for detailed guidance on this topic.
