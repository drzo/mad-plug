---
name: gh138
description: "138 - ASYNC TO THE QUEUE"
---
...
Give those parts of the repository where people sleep, an eastern orientation, so that they wake up with the sun and visibility. This means, typically, that the sleeping area needs to be on the eastern side of the repository; but it can also be on the western side provided there is a courtyard or a terrace to the east of it.
